...
public class LocalCacheInitializer {
	...
	public void initialize(String port , StringLocalCacheNotifyCallback callback0 , StringLocalCacheErrorCallback callback1) 
		...
		LocalCacheCommandMgr.getInstance().initialize(callback0 , callback1);
